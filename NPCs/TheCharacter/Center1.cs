...
{
    [AutoloadBossHead]
    public class Center1 : ModNPC
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("The Character(1)");
        }
        public override void SetDefaults()
        {
            npc.aiStyle = 110;
            aiType = NPCID.DD2Betsy;
            npc.lifeMax = 114514;        //this is the npc health
            npc.damage = 200;    //this is the npc damage
            npc.defense = 0;         //this is the npc defense
            npc.knockBackResist = 0f;
            npc.width = 189; //this is where you put the npc sprite width.     important
            npc.height = 140; //this is where you put the npc sprite height.   important
        ...
        {
            if (!NPC.AnyNPCs(mod.NPCType("Center2")) && !NPC.AnyNPCs(mod.NPCType("Center3")) && !NPC.AnyNPCs(mod.NPCType("Center4")))
            {
