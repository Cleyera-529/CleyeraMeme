...
{
    [AutoloadBossHead]
    public class Center2 : ModNPC
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("The Character(2)");
        }
        public override void SetDefaults()
        {
            ...
            npc.width = 164; //this is where you put the npc sprite width.     important
            npc.height = 188; //this is where you put the npc sprite height.   important
        ...
        {
            if (!NPC.AnyNPCs(mod.NPCType("Center1")) && !NPC.AnyNPCs(mod.NPCType("Center3")) && !NPC.AnyNPCs(mod.NPCType("Center4")))
            {
